...
def _row_for_run_dir(run_dir: Path) -> Dict[str, Any]:
    ...
    return dict(
        ...
        critic_partial_groups=_get_nested(flags, ["agent", "critic_partial_groups"]),
        critic_partial_iters_per_group=_get_nested(flags, ["agent", "critic_partial_iters_per_group"]),
