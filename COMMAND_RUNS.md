...
- `GOALDISTANCE_BACKBONE`, `GOALDISTANCE_RECUR_ITERS`, `GOALDISTANCE_RECUR_NUM_DENSE_LAYERS`, `GOALDISTANCE_RECUR_BLOCK_TYPE`, `GOALDISTANCE_RECUR_MAX_ITERS`, `GOALDISTANCE_RECUR_USE_STEP_INFO` for `CGIVL`

## CGIVL Recurrent Value / Goal-Distance

The first two commands are the cheaper first-pass tests: both the CGIVL value network and conservative `goal_distance` IQE embedding use `recur_tied`. They use the documented stitch-task actor mix `actor_p_trajgoal=0.5`, `actor_p_randomgoal=0.5`, quasimetric distillation mix `gd_p_trajgoal=0.8`, `gd_p_randomgoal=0.2`, and `neg_eps=0.01`. The giant commands below keep value as MLP and recur only the goal-distance branch until the large-stitch tests justify the larger budget.

```bash
# Antmaze large stitch: CGIVL with recurrent value and recurrent goal-distance IQE.
sbatch --array=1 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=CGIVL_AntLargeStitch_BothRecur,EXP_NAME=sd001_ALS_cgivl_value_gd_recur_tied_k4,TRAIN_STEPS=1000000,DISCOUNT=0.99,NEG_EPS=0.01,VALUE_BACKBONE=recur_tied,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_BLOCK_TYPE=swiglu,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,GOALDISTANCE_BACKBONE=recur_tied,GOALDISTANCE_RECUR_ITERS=4,GOALDISTANCE_RECUR_NUM_DENSE_LAYERS=2,GOALDISTANCE_RECUR_BLOCK_TYPE=swiglu,GOALDISTANCE_RECUR_MAX_ITERS=4,GOALDISTANCE_RECUR_USE_STEP_INFO=1,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,GD_P_CURGOAL=0.0,GD_P_TRAJGOAL=0.8,GD_P_RANDOMGOAL=0.2,EVAL_TASKS=5,EVAL_EPISODES=50,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_cgivl.slurm

# Humanoidmaze large stitch: CGIVL with recurrent value and recurrent goal-distance IQE.
sbatch --array=1 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=humanoidmaze-large-stitch-v0,RUN_GROUP=CGIVL_HumanoidLargeStitch_BothRecur,EXP_NAME=sd001_HLS_cgivl_value_gd_recur_tied_k4,TRAIN_STEPS=1000000,DISCOUNT=0.995,NEG_EPS=0.01,VALUE_BACKBONE=recur_tied,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_BLOCK_TYPE=swiglu,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,GOALDISTANCE_BACKBONE=recur_tied,GOALDISTANCE_RECUR_ITERS=4,GOALDISTANCE_RECUR_NUM_DENSE_LAYERS=2,GOALDISTANCE_RECUR_BLOCK_TYPE=swiglu,GOALDISTANCE_RECUR_MAX_ITERS=4,GOALDISTANCE_RECUR_USE_STEP_INFO=1,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,GD_P_CURGOAL=0.0,GD_P_TRAJGOAL=0.8,GD_P_RANDOMGOAL=0.2,EVAL_TASKS=5,EVAL_EPISODES=50,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_cgivl.slurm

# Antmaze giant stitch: CGIVL with recurrent goal-distance IQE.
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=antmaze-giant-stitch-v0,RUN_GROUP=CGIVL_AntGiantStitch_RecurGoalDistance,EXP_NAME=sd000_AGS_cgivl_gd_recur_tied_k4,TRAIN_STEPS=2000000,DISCOUNT=0.995,NEG_EPS=0.01,VALUE_BACKBONE=mlp,GOALDISTANCE_BACKBONE=recur_tied,GOALDISTANCE_RECUR_ITERS=4,GOALDISTANCE_RECUR_NUM_DENSE_LAYERS=2,GOALDISTANCE_RECUR_BLOCK_TYPE=swiglu,GOALDISTANCE_RECUR_MAX_ITERS=4,GOALDISTANCE_RECUR_USE_STEP_INFO=1,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,GD_P_CURGOAL=0.0,GD_P_TRAJGOAL=0.8,GD_P_RANDOMGOAL=0.2,EVAL_TASKS=5,EVAL_EPISODES=50,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_cgivl.slurm

# Humanoidmaze giant stitch: CGIVL with recurrent goal-distance IQE.
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=humanoidmaze-giant-stitch-v0,RUN_GROUP=CGIVL_HumanoidGiantStitch_RecurGoalDistance,EXP_NAME=sd000_HGS_cgivl_gd_recur_tied_k4,TRAIN_STEPS=3000000,DISCOUNT=0.995,NEG_EPS=0.01,VALUE_BACKBONE=mlp,GOALDISTANCE_BACKBONE=recur_tied,GOALDISTANCE_RECUR_ITERS=4,GOALDISTANCE_RECUR_NUM_DENSE_LAYERS=2,GOALDISTANCE_RECUR_BLOCK_TYPE=swiglu,GOALDISTANCE_RECUR_MAX_ITERS=4,GOALDISTANCE_RECUR_USE_STEP_INFO=1,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,GD_P_CURGOAL=0.0,GD_P_TRAJGOAL=0.8,GD_P_RANDOMGOAL=0.2,EVAL_TASKS=5,EVAL_EPISODES=50,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_cgivl.slurm
```
...
# HIQL ALS new stacked SwiGLU backbone, constant LR, 
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=1,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=HIQL_ALS_ConstLR,EXP_NAME=sd001_ALS_hiql_stacked_swi_m3k4_constlr,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=3,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm

# HIQL AGN new swiGLU
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=antmaze-giant-navigate-v0,RUN_GROUP=AGN_StackedSwiGLU,EXP_NAME=sd000_AGN_hiql_stacked_swi_m3k4_constlr,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=3,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,LR_DECAY_STEPS=0,DISCOUNT=0.995,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=1.0,ACTOR_P_RANDOMGOAL=0.0,WANDB_MODE=online" slurm/train_hiql.slurm

# HIQL new scene 
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=1,ENV_NAME=scene-play-v0,RUN_GROUP=HIQL_ScenePlay_StackedSwiGLU,EXP_NAME=sd001_SP_hiql_stacked_swi_m2k4_constlr,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=10,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm
...
# SAW Scene
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=3,ENV_NAME=scene-play-v0,RUN_GROUP=SAW_ScenePlay_SwiGLU,EXP_NAME=sd003_SP_SAW_m1K4,VALUE_BACKBONE=recur_tied,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_BLOCK_TYPE=swiglu,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_LAYERSCALE=1,DISCOUNT=0.99,EXPECTILE=0.7,LOW_ALPHA=3.0,AWR_ALPHA=3.0,KL_ALPHA=1.0,SUBGOAL_STEPS=10,WANDB_MODE=online" slurm/train_saw.slurm

# HIQL m2K4 AGN
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=5,ENV_NAME=antmaze-giant-navigate-v0,RUN_GROUP=HIQL_K4M2_ConstLR,EXP_NAME=sd005_AGN_hiql_stacked_swi_m2k4_constlr,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.995,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=1.0,ACTOR_P_RANDOMGOAL=0.0,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm

# HQIL ALS K4M2
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=5,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=HIQL_K4M2_ConstLR,EXP_NAME=sd005_ALS_hiql_stacked_swi_m2k4_constlr,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm


# HIQL CSP K4M2
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=cube-single-play-v0,RUN_GROUP=HIQL_K4M2_ConstLR,EXP_NAME=sd005_CSP_hiql_stacked_swi_m2k4_constlr,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=10,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm

# HIQL SP K4M2
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=5,ENV_NAME=scene-play-v0,RUN_GROUP=HIQL_K4M2_ConstLR,EXP_NAME=sd005_SP_hiql_stacked_swi_m2k4_constlr,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=10,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm
...
# CRL HLS
qsub -P personal -q normal \
  -v "SEEDS=0,ENV_NAME=humanoidmaze-large-stitch-v0,RUN_GROUP=CRL_HumanoidLargeStitch_StackedSwiGLU,EXP_NAME=sd000_HLS_CRL_m2K4,CRITIC_BACKBONE=recur_stacked_swiglu,KTRAIN=4,RECUR_NUM_DENSE_LAYERS=2,RECUR_MAX_ITERS=4,RECUR_USE_STEP_INFO=1,CRITIC_RECUR_USE_LAYERSCALE=1,ALPHA=0.1,DISCOUNT=0.995,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" \
  pbs/train_crl.pbs

# CRL HLN
qsub -P personal -q normal \
  -v "SEEDS=0,ENV_NAME=humanoidmaze-large-navigate-v0,RUN_GROUP=CRL_HumanoidLargeNavigate_StackedSwiGLU,EXP_NAME=sd000_HLN_CRL_m2k4,CRITIC_BACKBONE=recur_stacked_swiglu,KTRAIN=4,RECUR_NUM_DENSE_LAYERS=2,RECUR_MAX_ITERS=4,RECUR_USE_STEP_INFO=1,CRITIC_RECUR_USE_LAYERSCALE=1,ALPHA=0.1,DISCOUNT=0.995,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=1.0,ACTOR_P_RANDOMGOAL=0.0,EVAL_ON_CPU=0,WANDB_MODE=online" \
  pbs/train_crl.pbs

# HIQL HLS
qsub -P personal -q normal \
  -v "SEEDS=1,ENV_NAME=humanoidmaze-large-stitch-v0,RUN_GROUP=HIQL_HumanoidLargeStitch_K4M2_ConstLR,EXP_NAME=sd001_HLN_HIQL_m3k4,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=3,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.995,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" \
  pbs/train_hiql.pbs

# HIQL HLN
qsub -P personal -q normal \
  -v "SEEDS=1,ENV_NAME=humanoidmaze-large-navigate-v0,RUN_GROUP=HIQL_HumanoidLargeNavigate_K4M2_ConstLR,EXP_NAME=sd001_HLN_HIQL_m3k4,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=3,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.995,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=100,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=1.0,ACTOR_P_RANDOMGOAL=0.0,EVAL_ON_CPU=0,WANDB_MODE=online" \
  pbs/train_hiql.pbs
...
qsub -P personal -q normal \
  -v "SEEDS=1,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=HIQL_K4M2_ConstLR,EXP_NAME=sd001_ALS_hiql_stacked_swi_m2k4_constlr,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" \
  pbs/train_hiql.pbs

qsub -P personal -q normal \
  -v "SEEDS=2,ENV_NAME=cube-single-play-v0,RUN_GROUP=HIQL_K4M2_ConstLR,EXP_NAME=sd002_CSP_hiql_stacked_swi_m2k4_constlr,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_USE_INPUT_INJECTION=0,LR_DECAY_STEPS=0,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=10,EVAL_ON_CPU=0,WANDB_MODE=online" \
  pbs/train_hiql.pbs
