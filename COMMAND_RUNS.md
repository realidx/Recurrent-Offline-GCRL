...
sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=2,ENV_NAME=antmaze-giant-navigate-v0,RUN_GROUP=AGN_StackedSwiGLU,EXP_NAME=sd002_AGN_hiql_stacked_swi_m2k4,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,DISCOUNT=0.995,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=1.0,ACTOR_P_RANDOMGOAL=0.0,WANDB_MODE=online" slurm/train_hiql.slurm

sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=ALS_SwiGLU,EXP_NAME=sd000_ALS_hiql_stacked_swi_m2k4_evalOnGPU,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm

sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=ALS_SwiGLU,EXP_NAME=sd000_ALS_hiql_stacked_swi_m2k4_stepfirst,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_STEP_INFO_INNER_MODE=first,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm


sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=ALS_SwiGLU,EXP_NAME=sd000_ALS_hiql_stacked_swi_m2k4_noinnerres,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_STEP_INFO_INNER_MODE=all,VALUE_RECUR_USE_INNER_RESIDUAL=0,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm

sbatch --array=0 --gpus=h100-47 --export="ALL,SEEDS=0,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=ALS_SwiGLU,EXP_NAME=sd000_ALS_hiql_stacked_swi_m2k4_noinnerres_stepfirst,VALUE_BACKBONE=recur_stacked_swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,VALUE_RECUR_STEP_INFO_INNER_MODE=first,VALUE_RECUR_USE_INNER_RESIDUAL=0,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm


sbatch --array=0 --gpus=a100-40 --export="ALL,SEEDS=0,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=ALS_SwiGLU,EXP_NAME=sd000_ALS_hiql_swi_k4,VALUE_BACKBONE=recur_tied,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm

sbatch --array=0 --gpus=a100-40 --export="ALL,SEEDS=5,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=ALS_HIQL_Reproduce,EXP_NAME=sd005_ALS_hiql_mlp,VALUE_BACKBONE=mlp,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_hiql.slurm


sbatch --array=0 --gpus=a100-40 --export="ALL,SEEDS=1,ENV_NAME=antmaze-large-stitch-v0,RUN_GROUP=ALS_SwiGLU,EXP_NAME=sd001_ALS_hiql_swi_k4,VALUE_BACKBONE=recur_tied,VALUE_RECUR_BLOCK_TYPE=swiglu,VALUE_RECUR_ITERS=4,VALUE_RECUR_NUM_DENSE_LAYERS=2,VALUE_RECUR_MAX_ITERS=4,VALUE_RECUR_USE_STEP_INFO=1,DISCOUNT=0.99,LOW_ALPHA=3.0,HIGH_ALPHA=3.0,SUBGOAL_STEPS=25,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,WANDB_MODE=online" slurm/train_hiql.slurm
