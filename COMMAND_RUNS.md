...
jid_mlp=$(sbatch --parsable --array=0 --gpus=h100-47 --export="ALL,AUTO_RESUME=0,SEEDS=0,ENV_NAME=antmaze-medium-stitch-v0,RUN_GROUP=Fig4_AMS_CRL_Rerun,EXP_NAME=sd000_AMS_mlp_fig4,CRITIC_BACKBONE=mlp,ALPHA=0.1,DISCOUNT=0.99,ACTOR_P_CURGOAL=0.0,ACTOR_P_TRAJGOAL=0.5,ACTOR_P_RANDOMGOAL=0.5,EVAL_INTERVAL=1000000,SAVE_STEPS=1000000,DUMP_EVAL_TRAJS=1,EVAL_TRAJ_DIR=${ROOT}/paper/figures/fig4_trajs/mlp,EVAL_ON_CPU=0,WANDB_MODE=online" slurm/train_crl.slurm)
